...
function breaking_sentence_substring(){
...
function breaking_sentence_countEachLength(){
...
lets_form_a_sentence()
console.log("\n")
index_accessing()
console.log("\n")
breaking_sentence_substring()
console.log("\n")
breaking_sentence_countEachLength()